$(document).ready(function(){
    ...
    $('.fb').click(function(){
        ...
        $('#desc_ev').html("<div class='startpage' style='line-height:100%;'><span style='font-size:24px;'>"+nome_evento+"</span><br/><span id='span_local' style='font-size:14px;'>"+local+"<br/><span id='span_endereco' style='font-size:14px;'>"+endereco+"</span></div>") ;
    ...
    $('#close').click(function(){
        //É NECESSARIO REMOVER ESTES ELEMENTOS PARA NÃO DUPLICA-LOS NA PROXIMA CHAMADA
        $.fancybox.close();
