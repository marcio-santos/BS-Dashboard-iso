$(document).ready(function() {
    ...
    $('#change').click(function(){
        ...
        $.ajax({
            ...
            error: function (request, status, error)
            {
                var msg = '<span style="color: red">N�o foi possivel fechar este lote.<br/><pre>'+ request.responseText + '</pre><br/>' + status+'</span>' ;
...
//LISTA DE ESPERA
    ...
    $('#li_les').live('click',function(){
        ...
        $.ajax({
            ...
            error: function (request, status, error)
            {
                var msg = '<span style="color: red">N�o foi possivel carregar as informa��es.<br/><pre>'+ request.responseText + '</pre><br/>' + status+'</span>' ;
                $('#change_response').html(msg) ;
    ...
    $('#consultar_cpf').click(function(){
        ...
        $.ajax({
            ...
            error: function (request, status, error)
            {
                var msg = '<span style="color: red">N�o foi possivel gerar o boleto.<br/><pre>'+ request.responseText + '</pre><br/>' + status+'</span>' ;
...
function getEnvio() {
    ...
    $.ajax({
        ...
        error: function (request, status, error)
        {
            $('#controle_response').html('<span style="color: red">N�o foi possivel realizar a tarefa.<br/><pre>'+ request.responseText + '</pre><br/>' + status+'</span>');
        }
    });
}
...
function setEnvio(){
    ...
    $.ajax({
        ...
        error: function (request, status, error)
        {
            $('#controle_response').html('<span style="color: red">N�o foi possivel registrar o envio.<br/><pre>'+ request.responseText + '</pre><br/>' + status+'</span>');
        }
    });
}
...
function upEnvio(){
    ...
    $.ajax({
        ...
        error: function (request, status, error)
        {
            $('#controle_response').html('<span style="color: red">N�o foi possivel atualizar a informa��o.<br/><pre>'+ request.responseText + '</pre><br/>' + status+'</span>');
        }
    });
}
...
function goTransfer(){
    ...
    $.ajax({
        ...
        error: function (request, status, error)
        {
            var msg = '<span style="color: red">N�o foi possivel transferir este cliente.<br/><pre>'+ request.responseText + '</pre><br/>' + status+'</span>' ;
            $('#change_response').html(msg) ;
