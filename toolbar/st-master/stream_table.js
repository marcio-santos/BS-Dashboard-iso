...
(function(window, $) {
  ...
  _F.addSearchBox = function(){
    ...
    $(this.main_container).before('<input name="search" type="text" id="st_search" class="st_search" placeholder="Digite aqui...">');
  ...
  _F.renderPagination = function(page_count, current_page){
    ...
    if (page_count > span){
      links.push('<li><a href="#" class="first">Primeiro</a></li>');
    ...
    if (page_count > this.paging_opts.span) links.push('<li><a href="#" class="last">Último</a></li>');
