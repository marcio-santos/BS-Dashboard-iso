<?php
    ...
    $nossonumero = $_POST['nnum']; // Número de controle do Emissor (pode usar qq número de até 8 digitos);
    $data = $_POST['data_documento'];  //'05/03/2005'; // Data de emissão do boleto
    $vencimento = $_POST['data_vencimento'];   //'05/03/2006'; // Data no formato dd/mm/yyyy
    $valor = $_POST['valor_cobrado']; // Colocar PONTO no formato REAIS.CENTAVOS (ex: 666.01)
    ...
    $sacado = $_POST['sac'];
    $endereco_sacado = utf8_decode($_POST['endereco']) ;
    $cpf_cnpj =  $_POST['cpf'];

    $instrucoes1 =  utf8_decode($_POST['evento']);
    $instrucoes2 = 'NAO ACEITAR APOS VENCIMENTO';
    $instrucoes3 =  $_POST['cnab'];
    $instrucoes4 =  $_POST['transacaoid'];
    $instrucoes5 = '';
...
<tr>
    <td bgcolor="#FFFFFF"><table width="100%"  border="0" cellspacing="0" cellpadding="0">
            <tr>
                ...
                <td width="45%" valign="bottom"><div align="right"><img src="img/logo_bodysystems.png" width="124" height="50"></div></td>
            </tr>
            <tr>
